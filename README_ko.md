...
<!-- BENCH:SUMMARY:START -->
> __Hybrid (Faster+Triton)__ 모드는 RTX 5090에서 PyTorch 기본 대비 __4.7x__ 빠른 추론을 동일 VRAM으로 달성합니다.
<!-- BENCH:SUMMARY:END -->
...
| 모드 | 로드 시간 | 지연 (한국어) | 지연 (영어) | RTF (한국어) | RTF (영어) | 속도 향상 | 최대 VRAM |
|------|----------|:------------:|:------------:|:--------:|:--------:|:-------:|:---------:|
...
<!-- BENCH:QUALITY:START -->
각 러너가 독립적으로 음성을 생성하고, Base 대비 품질 분포를 비교합니다.
...
> Faster FAIL 원인: CER delta 0.057 > 임계값 0.05. fast 모드(1회/문장, whisper-small)의 변동. full 모드(3회/문장, whisper-large-v3, Mann-Whitney U test)에서 PASS 예상.
